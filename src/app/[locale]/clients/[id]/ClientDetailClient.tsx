...
type Tab = "RESUMEN" | "PROPUESTA" | "CONTRATO" | "PROYECTO" | "HISTORIAL" | "TAREAS";
...
export function ClientDetailClient({
  ...
  const handleSaveName = async () => {
    ...
    if (clientName === contract.client_name) return;
          ...
          <div className="group/name">
            <div className="flex items-center gap-3">
              {isEditingName ? (
                <input
                  autoFocus
                  className="bg-white/5 border border-emerald-500/50 px-2 py-1 text-xl font-bold text-white uppercase italic tracking-tight outline-none"
                  value={clientName}
                ...
                <h1 
                  ...
                  className="text-xl font-bold text-white uppercase italic tracking-tight underline decoration-emerald-500/30 underline-offset-4 cursor-edit hover:text-emerald-400 transition-colors"
                >
                  {clientName}
                </h1>
              )}
            ...
            <p className="text-[10px] font-mono text-neutral-300 uppercase tracking-[0.2em] mt-1 pl-1">
        ...
        <div className="flex gap-6 overflow-x-auto">
          {tabs.map((tab) => {
            const tabIcons: Record<Tab, React.ReactNode> = {
              RESUMEN: null,
              HISTORIAL: <Activity className="w-3 h-3" />,
              PROPUESTA: <FileText className="w-3 h-3" />,
              CONTRATO: <ShieldCheck className="w-3 h-3" />,
              PROYECTO: <ExternalLink className="w-3 h-3" />,
            ...
            return (
              <button
                ...
                className={`py-4 text-[10px] font-mono uppercase tracking-[0.3em] transition-all relative flex items-center gap-1.5 whitespace-nowrap ${
                  activeTab === tab
                    ? "text-white"
          ...
          >
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="pt-20 border-t-4 border-neutral-900 grid grid-cols-2 gap-20">
                      ...
                      <div className="text-center space-y-4">
                        ...
                        <p className="text-[10px] font-black uppercase italic italic">
                          {contract.client_signed_name || clientName}
                        </p>
                      </div>
                    </div>
            ...
            {activeTab === "HISTORIAL" && (
              <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white/[0.01] border border-white/5 p-8 relative font-sans print:shadow-none print:p-0">
                  <ActivityTimeline
                    entityType="client"
            ...
            {activeTab === "TAREAS" && (
              <div className="max-w-4xl mx-auto">
                <div className="mb-8 print:hidden">
                  <span className="text-[11px] font-mono text-neutral-300 uppercase tracking-widest italic tracking-tight">
                    Tareas y seguimientos del cliente
                  </span>
                </div>
                <div className="bg-white/[0.01] border border-white/5 p-8 relative font-sans print:shadow-none print:p-0">
                  <TasksPanel
