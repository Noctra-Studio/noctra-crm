...
const CONNECTIVITY_COPY = {
  es: {
    ...
    title: "La IA está dentro del sistema, no puesta encima como un extra.",
    radarTitle: "Una IA que ayuda al equipo con contexto real.",
    radarDescription:
      "Noctra puede resumir conversaciones, detectar oportunidades, sugerir follow-ups y ordenar información sin sacarte del flujo operativo.",
    chat:
    ...
    hubTitle: "Construido para equipos, diseñado para seguridad.",
    hubDescription:
      "El sistema aprende de la actividad del equipo, muestra a cada persona lo relevante para su rol y protege el contexto sensible del cliente.",
  ...
  en: {
    ...
    title: "AI is part of the system, not bolted on as an extra.",
    radarTitle: "AI that helps the team with real context.",
    radarDescription:
      "Noctra can summarize conversations, identify opportunities, suggest follow-ups, and organize information without pushing teams out of the workflow.",
    chat:
    ...
    hubDescription:
      "The system learns from team activity, shows each person what matters to their role, and protects sensitive client context.",
