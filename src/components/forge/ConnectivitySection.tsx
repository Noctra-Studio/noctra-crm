...
const CONNECTIVITY_COPY = {
  es: {
    eyebrow: "El cerebro de Noctra CRM",
    title: "La IA está dentro del sistema, no agregada por encima.",
    radarTitle: "Una IA que entiende el contexto de la relación.",
    radarDescription:
      "Noctra puede resumir conversaciones, detectar oportunidades, sugerir próximos pasos y ordenar información sin obligarte a salir del flujo operativo.",
    chat:
      '"Nos interesa avanzar. ¿Puedes resumirme lo pendiente y sugerir el siguiente paso para no atrasarnos?"',
    brain: "Noctra Brain",
    mode: "Tarea actual",
    optimized: "Ruta eficiente",
    tokenEfficiency: "Uso de IA",
    highRoi: "Optimizado",
    orchestratedAction: "Acción sugerida",
    generateContract: "Preparar seguimiento",
    hubTitle: "Construido para equipos, diseñado para proteger la información.",
    hubDescription:
      "El sistema aprende de la actividad del equipo, muestra a cada persona lo que le corresponde y mantiene la información sensible bajo control.",
    syncDocs: "Historial compartido",
    contractSigned: "Acceso por rol",
    newInvoice: "Dato protegido",
    createTask: "Próximo paso asignado",
  },
  en: {
    eyebrow: "The brain of Noctra CRM",
    title: "AI is built into the system, not bolted on top.",
    radarTitle: "AI that understands relationship context.",
    radarDescription:
      "Noctra can summarize conversations, identify opportunities, suggest next steps, and organize information without forcing teams out of the workflow.",
    chat:
    ...
    tokenEfficiency: "AI usage",
    highRoi: "Optimized",
    orchestratedAction: "Suggested action",
    generateContract: "Prepare follow-up",
    hubTitle: "Built for teams, designed to protect information.",
    hubDescription:
      "The system learns from team activity, shows each person what matters to their role, and keeps sensitive information under control.",
    syncDocs: "Shared history",
    contractSigned: "Role-based access",
    newInvoice: "Protected data",
    createTask: "Assigned next step",
  },
} as const;
