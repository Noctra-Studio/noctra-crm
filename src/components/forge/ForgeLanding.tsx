...
const LANDING_COPY = {
  es: {
    ...
    internalSystem:
      "Noctra CRM nace del trabajo de Noctra Studio diseñando operaciones comerciales y de servicio donde la estructura, la visibilidad y el seguimiento diario realmente importan.",
    painEyebrow: "El problema",
    painTitle: "El problema de gestionar clientes sin un sistema",
    productEyebrow: "Sistema de operaciones con clientes nativo en IA",
    productTitle: "Una operación con clientes más estructurada y visible",
    productDescription:
      "Noctra CRM no se limita a guardar contactos. Organiza pipeline, interacciones, historial y siguientes pasos en un solo sistema para que el equipo sepa qué está pasando, qué sigue y dónde intervenir.",
    workflowEyebrow: "Cómo funciona",
    workflowTitle: "Cómo funciona el sistema",
    featuresEyebrow: "Capacidades",
    featuresTitle: "Diseñado para operar relaciones con clientes con estructura, visibilidad y ayuda inteligente.",
    stackTitle: "Menos herramientas sueltas. Más estructura y visibilidad.",
    stackDescription:
      "Muchos negocios sostienen la operación de clientes entre inbox, hojas de cálculo y tableros. Noctra reúne contexto, responsables, siguientes pasos y ayuda inteligente dentro de un mismo sistema operativo.",
    ...
    audienceTitle: "Quién puede usar Noctra CRM como sistema de operaciones con clientes",
    principlesEyebrow: "Capacidades centrales",
    principlesTitle: "Tres capacidades que sostienen la operación",
    storyEyebrow: "Por qué construimos Noctra CRM",
    storyTitle: "Por qué construimos Noctra CRM",
    storyDescription:
      "La idea de Noctra CRM nace de una frustración real con CRMs que funcionan como bases de datos o como capas de automatización aisladas. Eran difíciles de adoptar, pedían demasiada administración manual y dejaban la ayuda inteligente fuera del flujo real de trabajo. Por eso Noctra se está construyendo como un sistema de operaciones con clientes nativo en IA: un sistema donde la estructura, la visibilidad y la asistencia inteligente forman parte de la misma operación. El producto sigue en una etapa temprana y todavía no ha sido usado ampliamente por clientes externos, pero se está diseñando con cuidado para ayudar a los equipos a operar relaciones con clientes con más claridad y menos fricción.",
    faqEyebrow: "Preguntas",
    faqTitle: "Lo que los equipos suelen preguntar antes de unirse al acceso anticipado.",
    finalTitle: "Sé de las primeras empresas en operar con Noctra CRM",
    finalDescription: "Abriremos el acceso de forma gradual mientras afinamos la estructura, la visibilidad y la ayuda inteligente del sistema.",
    ...
    painPoints: [
      ...
      ["Los líderes pierden tiempo pidiendo actualizaciones en lugar de ver el estado real", "Noctra CRM da visibilidad compartida de pipeline, historial y siguientes pasos en un mismo sistema"],
    ],
    steps: [
      ["01", "Captura leads", "Reúne cada nuevo contacto en un solo lugar desde el inicio para que ninguna oportunidad se pierda entre mensajes, formularios o referencias.", "UserPlus"],
      ["02", "Organiza oportunidades", "Ordena cada oportunidad por etapa, prioridad y responsable para que el equipo sepa qué está avanzando y qué necesita atención.", "Layers"],
      ["03", "Da seguimiento a las interacciones", "Guarda conversaciones, notas, archivos y acuerdos en un historial compartido para que cualquier persona entienda la relación con el cliente.", "Search"],
      ["04", "Automatiza follow-ups", "Mantén visibles los siguientes pasos con recordatorios y sugerencias para que el seguimiento no dependa solo de la memoria del equipo.", "Brain"],
      ["05", "Cierra oportunidades", "Llega al cierre con una vista clara del contexto, la actividad y el estado real de la oportunidad para decidir con más seguridad.", "BarChart2"],
    ],
    features: [
      ["Sparkles", "Sistema de operaciones con clientes nativo en IA", "Noctra reúne pipeline, interacciones, historial y ayuda inteligente dentro de un mismo sistema para que la operación con clientes sea más clara y operable."],
      ...
      ["Brain", "Asistencia inteligente", "Resume, organiza, sugiere siguientes pasos y ayuda a detectar oportunidades dentro del mismo flujo de trabajo."],
      ["Search", "Seguimiento visible", "Muestra qué se movió, qué está detenido y dónde hace falta intervenir para decidir mejor."],
    ...
    faqs: [
      ...
      ["¿Es solo un CRM?", "No. Noctra CRM se está construyendo como un sistema de operaciones con clientes nativo en IA. Además de registrar datos, organiza contexto, seguimiento, visibilidad compartida y ayuda inteligente dentro del mismo sistema."],
      ["¿Cómo funciona el uso de IA?", "La ayuda inteligente de Noctra trabaja dentro del sistema sobre conversaciones, historial, pipeline y actividad. Se activa cuando resume, organiza información, sugiere siguientes pasos o detecta oportunidades para que el equipo reciba apoyo útil y visible."],
    ...
    solutionDescription: "Un sistema de operaciones con clientes nativo en IA donde pipeline, historial, interacciones y siguientes pasos viven dentro de una sola operación clara.",
    audiences: [
      ...
      ["PyMES", "Superan rápido las hojas de cálculo pero no necesitan complejidad empresarial.", "Noctra aporta estructura, visibilidad y ayuda inteligente sin inflar la operación."],
    ...
    principles: [
      ["Estructura", "Centraliza pipeline, historial, responsables y siguientes pasos para que la operación no dependa de memoria ni herramientas sueltas."],
      ["Visibilidad", "Da a ventas, operación y liderazgo una vista compartida de lo que avanza, lo que se detiene y lo que requiere atención."],
      ["Asistencia inteligente", "La IA trabaja dentro del sistema para resumir, organizar, sugerir y señalar oportunidades usando el contexto real del cliente."],
    ],
  },
  en: {
    badge: "Early access planned for late 2026 to early 2027",
    heroTitle: "More than a CRM: an AI-native client operations system",
    personaFreelancer: "I work solo",
    personaAgency: "I lead a team",
    proDescription:
      "For professionals who need to run leads, follow-through, and client relationships with structure, visibility, and intelligent assistance without unnecessary complexity.",
    agencyDescription:
      "When client work is spread across messages, notes, and scattered sheets, operations lose structure and visibility. Noctra CRM brings context, follow-through, and next steps into an AI-native system so the team can work with more order.",
    startFree: "Join early access",
    watchDemo: "See the system",
    trustIndicators: ["AI-native client operations system", "Shared visibility", "Useful assistance"],
    builtBy: "Built from real operational work at Noctra Studio",
    internalSystem:
      "Noctra CRM grows out of Noctra Studio's work designing sales and service operations where structure, visibility, and daily follow-through matter.",
    painEyebrow: "The problem",
    painTitle: "The problem with managing clients without a system",
    productEyebrow: "AI-native client operations system",
    productTitle: "A more structured and visible way to run client work",
    productDescription:
      "Noctra CRM does more than store contacts. It organizes pipeline, interactions, history, and next steps in one system so the team can see what is happening, what comes next, and where to step in.",
    workflowEyebrow: "How it works",
    workflowTitle: "How the system works",
    featuresEyebrow: "Capabilities",
    featuresTitle: "Designed to run client relationships with structure, visibility, and intelligent assistance.",
    stackTitle: "Fewer loose tools. More structure and visibility.",
    stackDescription:
      "Many businesses run client operations across inboxes, spreadsheets, and task boards. Noctra keeps context, ownership, next steps, and intelligent assistance inside one operating system.",
    ...
    audienceTitle: "Who can use Noctra CRM as a client operations system",
    principlesEyebrow: "Core capabilities",
    principlesTitle: "Three capabilities that support the work",
    storyEyebrow: "Why we built Noctra CRM",
    storyTitle: "Why we built Noctra CRM",
    storyDescription:
      "The idea for Noctra CRM came from real frustration with CRMs that behave like databases or isolated automation layers. They were hard to adopt, required too much manual administration, and kept intelligent assistance outside the real workflow. That is why Noctra is being built as an AI-native client operations system where structure, visibility, and intelligent assistance are part of the same operating layer. The product is still in its early stages and has not yet been widely used with external clients, but it is being designed carefully to help teams run client relationships with more clarity and less friction.",
    faqEyebrow: "Questions",
    faqTitle: "What teams usually ask before joining early access.",
    finalTitle: "Be among the first businesses running Noctra CRM",
    finalDescription: "We're opening access gradually while we refine the system's structure, visibility, and intelligent assistance.",
    ...
    painPoints: [
      ...
      ["Leaders spend time asking for updates instead of seeing what is moving", "Noctra CRM gives the team shared visibility across pipeline, history, and next steps in one system"],
    ],
    steps: [
      ["01", "Capture leads", "Bring every new inquiry into one place from the start so no opportunity gets lost across messages, forms, or referrals.", "UserPlus"],
      ["02", "Organize opportunities", "Sort each opportunity by stage, priority, and owner so the team can quickly see what is moving and what needs attention.", "Layers"],
      ["03", "Track interactions", "Keep conversations, notes, files, and agreements in one shared history so anyone on the team can understand the client relationship.", "Search"],
      ["04", "Automate follow-ups", "Keep next steps visible with reminders and suggestions so follow-through does not depend only on memory.", "Brain"],
      ["05", "Close deals", "Move into each closing decision with a clear view of the context, recent activity, and real status of the opportunity.", "BarChart2"],
    ],
    features: [
      ["Sparkles", "AI-native client operations system", "Noctra brings pipeline, interactions, history, and intelligent assistance into one system so client operations are clearer and easier to run."],
      ...
      ["Brain", "Intelligent assistance", "Summarize, organize, suggest next steps, and help identify opportunities inside the same workflow."],
      ["Search", "Visible follow-through", "Show what moved, what stalled, and where attention is needed so teams can make better decisions."],
    ...
    faqs: [
      ...
      ["Is this just a CRM?", "No. Noctra CRM is being built as an AI-native client operations system. It does more than record data by organizing context, follow-through, shared visibility, and intelligent assistance inside the same system."],
    ...
    solutionTitle: "Noctra CRM",
    solutionDescription: "An AI-native client operations system where pipeline, history, interactions, and next steps live inside one clear operation.",
    audiences: [
      ...
      ["SMBs", "They outgrow spreadsheets before they can justify enterprise complexity.", "Noctra adds structure, visibility, and intelligent assistance without unnecessary overhead."],
    ...
    principles: [
      ["Structure", "Centralize pipeline, history, ownership, and next steps so operations do not depend on memory or disconnected tools."],
      ["Visibility", "Give sales, operations, and leadership a shared view of what is moving, what is stalled, and what needs attention."],
      ["Intelligent assistance", "AI works inside the system to summarize, organize, suggest, and surface opportunities using real client context."],
    ],
  },
} as const;
...
export default function ForgeLanding() {
  ...
  const [userType, setUserType] = useState<"pro" | "agency">("agency");
      ...
      <section className="min-h-screen flex flex-col items-center justify-center text-center px-6 relative overflow-hidden pt-36 md:pt-32">
        ...
        <div className="flex flex-col items-center gap-6 animate-in fade-in slide-in-from-bottom-16 duration-1000 delay-500 relative z-10">
          <div className="flex flex-col sm:flex-row items-center gap-4 flex-wrap justify-center w-full">
            <Link
              href="/waitlist"
              className="flex items-center justify-center gap-2 rounded-full h-12 px-8 text-base font-bold text-black bg-[#10b981] shadow-[0_0_0_1px_rgba(16,185,129,0.35),0_18px_40px_rgba(16,185,129,0.28)] hover:bg-[#34d399] hover:shadow-[0_0_0_1px_rgba(52,211,153,0.5),0_22px_48px_rgba(16,185,129,0.36)] transition-all duration-300 w-full sm:w-auto">
