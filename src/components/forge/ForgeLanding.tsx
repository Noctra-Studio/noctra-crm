...
const LANDING_COPY = {
  es: {
    ...
    proDescription:
      "Para profesionales que necesitan ordenar leads, seguimiento y relaciones con clientes dentro de un sistema claro con IA integrada desde el origen.",
    agencyDescription:
      "Para equipos que necesitan una vista compartida de pipeline, actividad y próximos pasos sin depender de chats, hojas de cálculo y memoria.",
    startFree: "Unirme al acceso anticipado",
    watchDemo: "Ver el sistema",
    trustIndicators: ["IA integrada en el sistema", "Uso de IA transparente", "Diseñado para negocios reales"],
    ...
    painTitle: "Sin un sistema claro, los leads se pierden y el seguimiento se vuelve inconsistente.",
    productEyebrow: "Vista general del sistema",
    productTitle: "Una vista operativa para clientes, pipeline y actividad.",
    productDescription:
      "Revisa clientes, oportunidades, actividad y próximos pasos en una sola interfaz para entender qué está pasando, qué sigue y dónde intervenir.",
    workflowEyebrow: "Flujo de trabajo",
    workflowTitle: "De la captura del lead al cierre, con un flujo entendible.",
    featuresEyebrow: "Capacidades",
    featuresTitle: "Capacidades para ordenar la relación con clientes y sostener el seguimiento.",
    stackTitle: "Menos herramientas sueltas, más claridad operativa.",
    stackDescription:
      "Muchos negocios sostienen ventas y seguimiento entre inbox, hojas de cálculo y tableros. Noctra reúne contexto, responsables y próximos pasos en un mismo sistema.",
    ...
    storyTitle: "Lo construimos para resolver la operación diaria, no para añadir otra capa de software.",
    storyDescription:
      "En Noctra Studio vimos el mismo patrón una y otra vez: leads perdidos, contexto disperso, seguimientos inconsistentes y poca visibilidad de lo que realmente estaba avanzando. Noctra CRM nace para dar estructura, IA integrada y visibilidad real al trabajo con clientes.",
    ...
    finalDescription: "Únete al acceso anticipado para recibir avances del producto, noticias del lanzamiento y la invitación cuando abramos las primeras cuentas.",
    finalFootnote: "Ventana estimada de lanzamiento: finales de 2026 a inicios de 2027.",
    painPoints: [
      ["Los leads llegan por mensajes, formularios y referencias sin un registro confiable", "Registra cada oportunidad en una línea de tiempo compartida"],
      ["El seguimiento depende de la memoria y no del proceso", "Mantén próximos pasos visibles para que ninguna oportunidad se enfríe"],
      ["El contexto importante se pierde entre chats, notas y hojas de cálculo", "Reúne historial, actividad y decisiones en un solo lugar"],
      ["El pipeline cambia según quién lo explique", "Dale al equipo una sola vista operativa"],
      ["Las herramientas de IA generan texto, pero no claridad operativa", "Usa IA dentro del flujo para resumir, organizar y sugerir acción"],
      ["Los líderes no saben con claridad qué avanza y qué está detenido", "Detecta bloqueos y movimiento sin reportes manuales"],
    ],
    steps: [
      ["01", "Captura leads con contexto", "Centraliza formularios, mensajes y referencias para que cada oportunidad entre al sistema con la información necesaria desde el inicio.", "UserPlus"],
      ["02", "Organiza oportunidades con claridad", "Ordena el pipeline por etapa, prioridad y siguiente acción para que el trabajo comercial avance con criterio compartido.", "Layers"],
      ["03", "Sigue cada interacción", "Conserva conversaciones, notas, documentos y decisiones en una sola historia compartida para que cualquier persona entienda la relación.", "Search"],
      ["04", "Automatiza follow-ups importantes", "Noctra detecta tareas repetitivas, recuerda próximos pasos y sugiere acciones cuando una oportunidad necesita atención.", "Brain"],
      ["05", "Cierra con mejor visibilidad", "Llega a cada negociación con una vista clara de actividad, responsables y estado real del pipeline.", "BarChart2"],
    ],
    features: [
      ["Sparkles", "Operación AI-native", "La IA forma parte del sistema y trabaja sobre el contexto real de clientes, conversaciones y pipeline para apoyar decisiones y seguimiento."],
      ["UserPlus", "Lead Management", "Captura, clasifica y prioriza oportunidades desde el primer contacto para que ninguna se pierda en el camino."],
      ["BarChart2", "Sales Pipeline", "Ordena etapas, responsables y siguiente acción para que el trabajo comercial avance con más consistencia."],
      ["Users", "Client History", "Conserva conversaciones, notas, archivos y acuerdos en una historia única que cualquier persona puede entender."],
      ["Brain", "Automations", "Genera recordatorios, sugerencias y follow-ups donde el equipo ya trabaja, sin cambiar de herramienta."],
      ["Search", "Analytics & Visibility", "Muestra qué se movió, qué está detenido y dónde hace falta intervenir para decidir mejor."],
      ["Globe", "Colaboración bilingüe", "Funciona en español e inglés para mantener alineación entre personas, áreas y sedes."],
      ["Shield", "Acceso por roles", "Cada usuario ve lo relevante para su trabajo sin exponer más información de la necesaria."],
    ...
    faqs: [
      ...
      ["¿Cómo funciona el uso de IA?", "Cada plan incluye capacidad de uso de IA. Esa capacidad se utiliza cuando Noctra genera resúmenes, sugerencias o insights dentro del flujo de trabajo."],
    ...
    solutionDescription: "Un sistema AI-native para clientes, pipeline, historial y seguimiento dentro de una sola lógica operativa.",
    audiences: [
  ...
  en: {
    ...
    proDescription:
      "For professionals who need to organize leads, follow-through, and client relationships inside one clear system with AI built in from the start.",
    agencyDescription:
      "For teams that need a shared view of pipeline, activity, and next steps without relying on chat threads, spreadsheets, and memory.",
    startFree: "Join early access",
    watchDemo: "See the system",
    trustIndicators: ["AI built into the system", "Transparent AI usage", "Built for real businesses"],
    ...
    painTitle: "Without a clear system, leads get lost and follow-through becomes inconsistent.",
    productEyebrow: "System overview",
    productTitle: "An operational view of clients, pipeline, and activity.",
    productDescription:
      "Review clients, opportunities, activity, and next steps in one interface so the team can see what is happening, what comes next, and where to step in.",
    workflowEyebrow: "Workflow",
    workflowTitle: "From lead capture to close, in a flow people can actually follow.",
    featuresEyebrow: "Capabilities",
    featuresTitle: "Capabilities built to organize client relationships and sustain follow-through.",
    stackTitle: "Fewer loose tools, more operational clarity.",
    stackDescription:
      "Many businesses hold sales and follow-through together across inboxes, spreadsheets, and task boards. Noctra keeps context, ownership, and next steps inside one system.",
    ...
    storyTitle: "We built it to fix daily operations, not to add another software layer.",
    storyDescription:
      "At Noctra Studio we kept seeing the same pattern: lost leads, fragmented context, inconsistent follow-up, and limited visibility into what was actually moving. Noctra CRM is being built to bring structure, embedded AI, and real visibility to client work.",
    faqEyebrow: "Questions",
    faqTitle: "What teams usually ask before joining early access.",
    finalTitle: "Be among the first businesses using Noctra CRM.",
    finalDescription: "Join early access to receive product updates, launch news, and the invitation when we open the first accounts.",
    finalFootnote: "Estimated launch window: late 2026 to early 2027.",
    painPoints: [
      ["Leads arrive through messages, forms, and referrals with no reliable shared record", "Capture every opportunity inside one shared timeline"],
      ["Follow-ups depend on memory instead of process", "Keep next steps visible so no opportunity goes cold"],
      ["Important context gets buried across chats, notes, and spreadsheets", "Bring history, activity, and decisions into one system"],
      ["The pipeline looks different depending on who you ask", "Give the whole team one operational view"],
      ["AI tools create text, but not operational clarity", "Use AI inside the workflow to summarize, organize, and suggest action"],
      ["Leaders cannot clearly see what is moving and what is stuck", "Spot momentum and bottlenecks without manual reporting"],
    ],
    steps: [
      ["01", "Capture leads with context", "Bring forms, messages, and referrals into one system so every opportunity starts with the information the team actually needs.", "UserPlus"],
      ["02", "Organize opportunities clearly", "Structure the pipeline by stage, priority, and next action so commercial work can move with shared judgment.", "Layers"],
      ["03", "Track every interaction", "Keep conversations, notes, files, and decisions inside one shared relationship history.", "Search"],
      ["04", "Automate the follow-ups that matter", "Noctra identifies repetitive work, reminds the team about next steps, and suggests action when an opportunity needs attention.", "Brain"],
      ["05", "Close with better visibility", "Reach each decision point with a clear view of activity, ownership, and real pipeline status.", "BarChart2"],
    ],
    features: [
      ["Sparkles", "AI-native operations", "AI is part of the system and works with real client, conversation, and pipeline context to support judgment and follow-through."],
      ["UserPlus", "Lead Management", "Capture, classify, and prioritize opportunities from first contact so none of them disappear in the process."],
      ["BarChart2", "Sales Pipeline", "Organize stages, ownership, and next action so commercial work moves with more consistency."],
      ["Users", "Client History", "Keep conversations, notes, files, and agreements in one record any teammate can understand."],
      ["Brain", "Automations", "Create reminders, suggestions, and follow-ups where the team already works instead of sending them elsewhere."],
      ["Search", "Analytics & Visibility", "Show what moved, what stalled, and where attention is needed so teams can make better decisions."],
      ["Globe", "Bilingual collaboration", "Work in Spanish or English while keeping the same structured operational view."],
      ["Shield", "Role-based access", "Each user sees the information relevant to their role without exposing more than necessary."],
    ...
    solutionTitle: "Noctra CRM",
    solutionDescription: "One AI-native client operations system for clients, pipeline, history, and follow-through inside a single operating logic.",
    audiences: [
