...
const COMPARISON_COPY = {
  es: {
    ...
    fairUse: "",
    eyebrow: "Comparativa",
    title: "La diferencia no es una feature más. Es cómo funciona todo el sistema.",
    description:
      "Noctra CRM no busca parecerse a un CRM tradicional. Está diseñado para ordenar relaciones, trabajo y seguimiento dentro de una sola lógica operativa.",
    recommended: "AI-native",
    starterCta: "Ver el problema",
  ...
  en: {
    ...
    fairUse: "",
    eyebrow: "Comparison",
    title: "The difference is not one more feature. It is how the whole system works.",
    description:
      "Noctra CRM is not trying to look like a traditional CRM. It is designed to bring relationships, work, and follow-through into one operating logic.",
    recommended: "AI-native",
